...
def get_dataloader(
    ...
    # print(f'root_dir={root_dir}, batch_size={batch_size}, dali={dali}, local_rank={local_rank}, dali_aug={dali_aug}')
    # Synthetic
    ...
    if dali:
        # print("Use DALI")
        # print(f'batch_size={batch_size}, rec_file={rec}, idx_file={idx}, num_threads=2, local_rank={local_rank}, dali_aug={dali_aug}')
